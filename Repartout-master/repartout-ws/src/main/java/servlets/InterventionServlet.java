...
import services.TelediagService;
...
public class InterventionServlet extends HttpServlet {
   ...
   /* private void insertIntervention(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    private void insertIntervention(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // ✅ INTÉGRATION TELEDIAG - NOUVEAU CODE
        System.out.println("=== DÉBUT INTÉGRATION TELEDIAG ===");
        System.out.println("Machine ID: " + machineId);
        
        TelediagService telediagService = new TelediagService();
        boolean hasTelediag = telediagService.machineHasTelediag(machineId);
        
        System.out.println("Machine a Telediag ? " + hasTelediag);
        
        if (hasTelediag) {
            System.out.println("Récupération du diagnostic Telediag...");
            telediagService.enrichInterventionWithTelediag(intervention);
            
            // DEBUG après enrichissement
            System.out.println("Description après Telediag: " + intervention.getDescriptionProbleme());
            System.out.println("Notes après Telediag: " + intervention.getNotes());
        } else {
            System.out.println("Aucun diagnostic Telediag disponible pour cette machine");
        }
        
        System.out.println("=== FIN INTÉGRATION TELEDIAG ===");
